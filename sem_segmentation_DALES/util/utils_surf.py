...
# from sem_segmentation.modules.pointops.functions import pointops
...
def get_class_weights(dataset_name):
    ...
    if dataset_name == 'S3DIS_A1':
        ...
        # num_per_class = [0.28459923, 0.32990557, 0.1999722, 12.0798185, 13.3784535, 5., 5.3323316, 5.753585,
        #                  5.00199521, 30.3657772, 0.7987055, 10.2384844, 0.48565471]
        num_per_class = [0.28459923, 0.32990557, 0.1999722, 12.0798185, 13.3784535, 5., 5.3323316, 5.753585, 5.00199521]
...
def get_model(args):
    module = importlib.import_module('segmentation.models.%s' % args.model)
