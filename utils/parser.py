...
def get_args():
    ...
    parser.add_argument('--checkpoint', default="/data/Point-adapter/exprement_adamw/exprement_class_pointnet_l4_no_cat_dwconv3_GF", type=str, metavar='PATH',
                        help='path to save checkpoint (default: checkpoint)')
    parser.add_argument('--msg', type=str, help='message after checkpoint')
    # parser.add_argument('--batch_size', type=int, default=16,
    #                     help='batch size in training')
    parser.add_argument('--model', default='PCTAdapter', help='model_name')
    ...
    parser.add_argument(
        '--config',
        type=str,
        default='/data/Point-adapter/cfgs/Mixup_models/PCTAdapter.yaml',
    ...
    args.experiment_path = os.path.join('/data/Point-adapter/exprement',  args.exp_name)
    args.tfboard_path = os.path.join('/data/Point-adapter/exprement','TFBoard' ,args.exp_name)
